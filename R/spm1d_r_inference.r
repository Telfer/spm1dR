...
#' @export
inference.SPM0D_T <- function(spm, alpha = 0.05, two_tailed = TRUE, ...) {
...
#' @export
inference.SPM0D_F <- function(spm, alpha = 0.05, ...) {
...
#' @export
inference.SPM0D_X2 <- function(spm, alpha = 0.05, ...) {
...
#' Inference for 0D T² statistic
#' @export
inference.SPM0D_T2 <- function(spm, alpha = 0.05, ...) {
...
#' @export
inference.SPM_T <- function(spm, alpha = 0.05, two_tailed = TRUE, 
                            cluster_threshold = NULL, withBonf = TRUE, ...) {
...
#' @export
inference.SPM_F <- function(spm, alpha = 0.05, withBonf = TRUE, ...) {
...
#' @export
inference.SPM_X2 <- function(spm, alpha = 0.05, ...) {
...
#' Inference for 1D T² statistic
#' @export
inference.SPM_T2 <- function(spm, alpha = 0.05, ...) {
...
plot.SPMi <- function(x, 
  ...
  if (is.null(main)) {
    main <- sprintf("SPM{%s} Inference (α = %.3f)", x$STAT, x$alpha)
  }
  ...
  if (plot_threshold) {
    legend_text <- c(legend_text, sprintf("Threshold (α=%.3f)", x$alpha))
